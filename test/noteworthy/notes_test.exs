defmodule Noteworthy.NotesTest do
  use Noteworthy.DataCase
  ...
  describe "notes" do
    ...
    import Noteworthy.NotesFixtures

    @invalid_attrs %{content: nil, done: nil, title: nil}

    test "list_notes/0 returns all notes" do
      note = note_fixture() |> IO.inspect()
    ...
    #   valid_attrs = %{content: "some content", done: true, title: "some title"}

    #   assert {:ok, %Note{} = note} = Notes.create_note(valid_attrs)
    #   assert note.content == "some content"
    #   assert note.done == true
    ...
    #   note = note_fixture()
    #   update_attrs = %{content: "some updated content", done: false, title: "some updated title"}
